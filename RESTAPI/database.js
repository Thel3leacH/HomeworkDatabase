...
app.get('/students', async (req,res) => {
    ...
    res.render('student', { students: rows }); //เช็คชื่อ file .ejs ให้ถูกต้อง เช่น ตัวอักษรไม่ครบ หรือตัวเล็ก/ตัวใหญ่
})
...
app.post("/students", async (req, res) => {
    ...
    // res.status(201).send('<h1 style="color:red;">คุณได้ทำการเพิ่มข้อมูลเรียบร้อยแล้ว</h1>')
    res.status(201).send(`<h1 style="color:blue;"> Already add list to database ${rows[0].affectedRows} rows</h1>`)
